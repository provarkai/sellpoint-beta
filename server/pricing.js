...
const TIERS = {
  starter: {
    ...
    tagline: "Free - 30 orders/month, 5 products, basic invoices, AI samples, and a public storefront",
  },
  growth: {
    ...
    tagline: "Unlimited orders, 30 products, branded invoices, a public storefront, unlimited free receipts",
  },
  pro: {
    ...
    tagline: "Everything in Growth plus 3 staff, a second branch, suppliers, batch tracking, POS mode, and more AI generations",
  },
  business: {
    ...
    tagline: "Everything in Pro plus up to 20 staff, 20 branches, and advanced reports",
  },
  enterprise: {
